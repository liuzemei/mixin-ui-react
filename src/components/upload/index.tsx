...
export function Upload(props: UploadProps) {
  ...
  const showSlice = useMemo(() => {
    return (!multiple && uploadMode === 'img')
  }, [multiple, uploadMode])
  ...
  const canvasDraw = function(
    ...
    canvas.height = canvas.height || 0 //清屏
    ...
    <div>
      ...
      >
        ...
        <div style={{ marginTop: "10px" }}>
          ...
          >
            <Icon icon="zoom" color={color.light}/>
          </Button>
          <Button
            appearance="primary"
            style={btnStyle}
          ...
          >
            <Icon icon="zoomout" color={color.light}/>
          </Button>
          <Button
            appearance="primary"
            style={btnStyle}
          ...
          >
            <Icon icon="undo" color={color.light}/>
          </Button>
          <Button
            appearance="primary"
          ...
          >
            <Icon icon="zoomreset" color={color.light}/>
          </Button>
        </div>
      </Modal>
    </div>
